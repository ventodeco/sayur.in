            ...
            <div class="modal-content bg-white border-0">
              ...
              <div class="modal-body" style="padding: 2rem; padding-top: 0; padding-bottom: 0">
                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('cari-resep') }}">Cari Resep</a>
                  </li>
                  @auth
                    <li class="nav-item">
                      <a class="nav-link" href="{{ route('show-keranjang') }}">Keranjang</a>
                    </li>
                    <li class="nav-item">
                    ...
                    @php
                      $user = auth()->user();
                      $isAdmin = ($user && $user->roles == 'admin') ? true : false;
                    @endphp
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="">
                        ...
                        <nav class="list-unstyled">
                            ...
                            <li class="list-space">
                                <a href="{{ route('cari-resep') }}" class="list-menu">Cari Resep</a>
                            </li>
                            @auth
                              <li class="list-space">
                                  <a href="{{ route('show-keranjang') }}" class="list-menu">Keranjang</a>
                              </li>
                              <li class="list-space">
                                <a href="{{ route('pesanan') }}" class="list-menu">Pesanan</a>
                            </li>
                            @endauth
                        </nav>
                    </div>
